...
export class PicSureResourceService {
  ...
  getTreeCounts(constraint: any): Observable<any> { // todo: NONON
    return null; // todo
  }

  getPatientsCounts(constraint: Constraint): Observable<number> {
    ...
    return this.runQuery(
      ...
      .map((result) => result['data'][0][0]['patient_set_counts']);
  }
